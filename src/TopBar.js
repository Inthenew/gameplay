            ...
            return (
                <div>
                    <ul id="nav">
                        ...
                        <FormControl style={{width: '30%', selfAlign: 'center', display: 'inline-block',   position: 'absolute', left: '35%'}} type="text" placeholder="Search" className="" id="search"/>
                        <br/>
                        <br/>
                    </ul>
                    <div id="info23">
